                    ...
                    <ul id="siklusBudidaya" class="collapse submenu list-unstyled" data-bs-parent="#sidebar">
                        ...
                        <li>
                            ...
                            <ul id="appInvoice" class="mx-3 collapse list-unstyled sub-submenu">
                                ...
                                <li>
                                    <router-link to="/budidaya-kimia" @click="toggleMobileMenu">Pamareter Kimia </router-link>
                                </li>
                                <li>
                                    <a class="dropdown-toggle" href="#budidayaBiologi" data-bs-parent="#budidayaBiologi" data-bs-toggle="collapse" role="button" aria-expanded="false">
                                        Parameter Biologi
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="13"
                                    ...
                                    <ul id="budidayaBiologi" class="mx-3 collapse list-unstyled sub-submenu">
                                        <li>
                                            <router-link to="/parameter-biologi-fitoplankton" @click="toggleMobileMenu"> Filoplankton </router-link>
                                        </li>
                                        <li>
