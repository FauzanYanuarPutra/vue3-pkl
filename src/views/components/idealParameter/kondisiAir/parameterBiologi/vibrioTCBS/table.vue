                ...
                <div class="panel br-6 p-0">
                    <div class="custom-table">
                        ...
                        <div class="d-flex flex-row-reverse position-relative">
                            <router-link to="/parameter-biologi-vibrioTCBS/create" @click="toggleMobileMenu" class="btn mb-2 mx-3 tambah-data">Tambah Data</router-link>
                        </div>
                        <v-client-table :data="items" :columns="columns" :options="table_option">
                            <template #actions="props">
                                <div class="table-controls d-flex no-wrap justify-content-center">
                                    ...
                                    <div class="px-2">
                                        <router-link to="/parameter-biologi-vibrioTCBS/edit" data-bs-toggle="tooltip" title="Edit">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="24"
                                                height="24"
...
<script setup>
    ...
    const view_row = (item) => {
        new window.Swal({
            title: '<i>Parameter Biologi(Vibrio TCBS)</i>',
            text: 'HALLO',
