...
<script setup>
    ...
    const columns = ref(['ph', 'do', 'salinitas', 'Alkalinitas' ,  'co3', 'hc03', 'total', 'ammonium-nh4', 'nitrit-no2', 'nitrot-no3', 'phosphate-po4', 'iron-fe', 'magnesium-mg', 'calium-ca', 'residual_cholorin-ci', 'redox' ,'actions']);
    const items = ref([]);
    const table_option = ref({
        ...
        sortable: ['ph', 'do', 'salinitas', 'Alkalinitas', 'co3', 'hc03', 'total', 'ammonium-nh4', 'nitrit-no2', 'nitrot-no3', 'phosphate-po4', 'iron-fe', 'magnesium-mg', 'calium-ca', 'residual_cholorin-ci', 'redox'  ],
        sortIcon: {
            base: 'sort-icon-none',
            up: 'sort-icon-asc',
            down: 'sort-icon-desc',
