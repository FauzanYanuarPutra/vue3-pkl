<template>
    <div class="layout-px-spacing dash_1 mx-2 my-3">
        ...
        <div class="container">
            <div id="sterilisasiTambak" class="col-lg-12">
                        ...
                        <form class="form-vertical" action="#">
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex w-100">
                                    <input type="text" name="pemakaian_sterilisasi" class="form-control" />
                                    <input type="text" name="pemakaian_sterilisasi" class="form-control" />
                                    <input type="text" name="pemakaian_sterilisasi" class="form-control" />
                                </div>
                            </div>
...
<script setup>
    ...
    const options2 = ref(['Sterilisasi Tambak 1', 'Sterilisasi Tambak 2', 'Sterilisasi Tambak 3']);
