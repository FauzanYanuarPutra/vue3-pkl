...
const columns = ref(['id_tambak', 'id_kolam', 'nama_kolam', 'luas_kolam', 'tinggi_kolam', 'status', 'actions']);
const items = ref([]);
const table_option = ref({
    ...
    sortable: ['id_tambak', 'id_kolam', 'nama_kolam', 'tipe_kolam', 'luas_kolam', 'tinggi_kolam', 'jenis_kolam', 'pilih_kincir', 'pilih_pompa', 'pilih_auto_feeder', 'status'],
    sortIcon: {
        base: 'sort-icon-none',
        up: 'sort-icon-asc',
        down: 'sort-icon-desc',
...
const view_row = (item) => {
    new window.Swal({
        ...
        text: 'HALLO',
        html:
            '<p><b>Nama Tambak</b> : ' + item.id_tambak + '</p>' +
            '<p><b>Nama Kolam</b> : ' + item.nama_kolam + '</p>' +
            '<p><b>Tipe Kolam</b> : ' + item.tipe_kolam + '</p>' +
            '<p><b>Luas kolam (meter persegi)</b> : ' + item.luas_kolam + '</p>' +
            '<p><b>Tinggi kolam (meter)</b> : ' + item.tinggi_kolam + '</p>' +
            '<p><b>Jenis kolam</b> : ' + item.jenis_kolam + '</p>' +
            '<p><b>Pilih kincir</b> : ' + item.pilih_kincir + '</p>' +
            '<p><b>Pilih pompa</b> : ' + item.pilih_pompa + '</p>' +
            '<p><b>Pilih auto feeder</b> : ' + item.pilih_auto_feeder + '</p>' +
