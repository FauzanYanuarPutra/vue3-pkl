                ...
                <li>
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page"><span>Table Manage Kolam</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                ...
                <div class="panel br-6 p-0">
                    <div class="custom-table">
                        ...
                        <div class=" d-flex flex-row-reverse position-relative">
                            <router-link to="/manage-kolam/create" @click="toggleMobileMenu" class="btn btn-primary mb-2 mx-3 tambah-data">Tambah Data</router-link>
                        </div>
...
<script setup>
    ...
    const table_option = ref({
        ...
        sortable: ['id_tambak', 'id_kolam', 'nama_kolam', 'tipe_kolam', 'luas_kolam', 'tinggi_kolam', 'jenis_kolam', 'pilih_kincir', 'pilih_pompa', 'pilih_autofeeder', 'tinggi_kolam', 'status'],
        sortIcon: {
            base: 'sort-icon-none',
            up: 'sort-icon-asc',
            down: 'sort-icon-desc',
