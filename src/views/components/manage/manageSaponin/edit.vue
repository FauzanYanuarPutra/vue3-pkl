<template>
    <div class="layout-px-spacing dash_1 mx-2 my-3">
        ...
        <div class="container">
            <div id="saponin" class="col-lg-12">
                        ...
                        <form class="form-vertical" action="#">
                            <div class="box-wrap">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_tambak" class="form-control" placeholder="Masukkan nama tambak" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="jenis" class="form-control" placeholder="Contoh data, Vit C, Vit A, pupuk amonia" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="internal_id" class="form-control" placeholder="Tambahkan status" />
                                </div>
                            </div>
