                ...
                <div class="panel br-6 p-0">
                    <div class="custom-table">
                        ...
                        <div class="d-flex flex-row-reverse position-relative">
                            <router-link to="/manage-user/create" @click="toggleMobileMenu"
...
const table_option = ref({
    ...
    sortable: ['nama', 'jabatan', 'no_hp', 'tgl_bergabung', 'status', 'tambak', 'akses_terakhir'],
    sortIcon: {
        base: 'sort-icon-none',
        up: 'sort-icon-asc',
        down: 'sort-icon-desc',
...
const view_row = (item) => {
    new window.Swal({
        ...
        html:
            ...
            '<p><b>Jenis Kelamin</b> : ' + item.jenkel + '</p>' +
            '<p><b>Status</b> : ' + item.status + '</p>' +
            '<p><b>Alamat rumah</b> : ' + item.alamat + '</p>' +
            '<p><b>Tanggal bergabung</b> : ' + item.tgl_bergabung + '</p>' +
            '<p><b>Status</b> : ' + item.status1 + '</p>' +
            '<p><b>Team tambak</b> : ' + item.team_tambak + '</p>' +
            '<p><b>Supervisor</b> : ' + item.supervisor + '</p>' +
            '<p><b>Access right</b> : ' + item.access_right + '</p>' +
            '<p><b>Akses terakhir</b> : ' + item.akses_terakhir + '</p>'
        // '<p><b>Nama</b> : ' + item.nama + '</p>'+
        // '<p><b>Nama</b> : ' + item.nama + '</p>'+
        // '<p><b>Nama</b> : ' + item.nama + '</p>'+
        // '<p><b>Nama</b> : ' + item.nama + '</p>'+
