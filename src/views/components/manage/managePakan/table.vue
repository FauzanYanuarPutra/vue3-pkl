...
const columns = ref(['no', 'nama_tambak', 'tanggal_input', 'asal_pakan', 'jenis_butiran', 'actions']);
...
const view_row = (item) => {
    new window.Swal({
        ...
        html:
            ...
            item.tanggal_beli +
            '</p>' +
            '<p><b>Ukuran (Kg) / karung</b> : ' + item.ukuran_karung + '</p>' +
            '<p><b>Jumlah karung</b> : ' + item.jumlah_karung + '</p>' +
