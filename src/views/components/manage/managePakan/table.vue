                ...
                <div class="panel br-6 p-0">
                    <div class="custom-table">
                        ...
                        <div class=" d-flex flex-row-reverse position-relative">
                            <router-link to="/manage-pakan/create" @click="toggleMobileMenu" class="btn btn-primary mb-2 mx-3 tambah-data">Tambah Data</router-link>
                        </div>
...
const columns = ref(['nama_tambak', 'Tanggal_dan_jam_input', 'ID_Pakan', 'Asal_Pakan', 'Pakan_batch_id', 'Jenis_butiran', 'Tanggal_beli',
    'Ukuran_Karung', 'photo', 'status', 'Scoring_Pakan', 'Aktraktan', 'Protein_untuk_pertumbuhan', 'Keterangan', 'actions']);
const items = ref([]);
const table_option = ref({
    ...
    sortable: ['nama_tambak', 'Tanggal_dan_jam_input', 'ID_Pakan', 'Asal_Paan', 'Pakan_batch_id', 'Jenis_butiran', 'Tanggal_beli',
        'Ukuran_Karung', 'photo', 'status', 'Scoring_Pakan', 'Aktraktan', 'Protein_untuk_pertumbuhan', 'Keterangan'],
    sortIcon: {
        base: 'sort-icon-none',
        up: 'sort-icon-asc',
        down: 'sort-icon-desc',
...
const bind_data = () => {
    items.value = [
        ...
        },
        {
            ...
            Tanggal_dan_jam_input: 'nama_area Manager',
            Asal_Pakan: 'London',
            Pakan_batch_id: 30,
            Jenis_butiran: 61,
            Tanggal_beli: 61,
        ...
        },
        {
            ...
            Tanggal_dan_jam_input: 'Support Lead',
            Asal_Pakan: 'Edinburgh',
            Pakan_batch_id: 22,
            Jenis_butiran: 61,
            Tanggal_beli: 61,
        ...
        },
        {
            ...
            Tanggal_dan_jam_input: 'Regional Director',
            Asal_Pakan: 'San Francisco',
            Pakan_batch_id: 36,
            Jenis_butiran: 61,
            Tanggal_beli: 61,
        ...
        },
        {
            ...
            Tanggal_dan_jam_input: 'Senior Marketing Designer',
            Asal_Pakan: 'London',
            Pakan_batch_id: 43,
            Jenis_butiran: 61,
            Tanggal_beli: 61,
...

        {
            ...
            Tanggal_dan_jam_input: 'Marketing Designer',
            Asal_Pakan: 'London',
            Pakan_batch_id: 66,
            Jenis_butiran: 61,
            Tanggal_beli: 61,
...

        {
            ...
            Tanggal_dan_jam_input: 'Chief Financial nama_arear (CFO)',
            Asal_Pakan: 'New York',
            Pakan_batch_id: 64,
            Jenis_butiran: 61,
            Tanggal_beli: 61,
        ...
        },
        {
            ...
            Tanggal_dan_jam_input: 'Systems Administrator',
            Asal_Pakan: 'New York',
            Pakan_batch_id: 59,
            Jenis_butiran: 61,
            Tanggal_beli: 61,
        ...
        },
        {
            ...
            Tanggal_dan_jam_input: 'Personnel Lead',
            Asal_Pakan: 'Edinburgh',
            Pakan_batch_id: 35,
            Jenis_butiran: 61,
            Tanggal_beli: 61,
        ...
        },
        {
            ...
            Tanggal_dan_jam_input: 'Development Lead',
            Asal_Pakan: 'New York',
            Pakan_batch_id: 61,
            Jenis_butiran: 61,
            Tanggal_beli: 61,
        ...
        },
        {
            ...
            Tanggal_dan_jam_input: 'Chief Marketing nama_arear (CMO)',
            Asal_Pakan: 'New York',
            Pakan_batch_id: 40,
            Jenis_butiran: 61,
            Tanggal_beli: 61,
        ...
        },
        {
            ...
            Tanggal_dan_jam_input: 'Pre-Sales Support',
            Asal_Pakan: 'New York',
            Pakan_batch_id: 21,
            Jenis_butiran: 61,
            Tanggal_beli: 61,
        ...
        },
        {
            ...
            Tanggal_dan_jam_input: 'Chief Executive nama_arear (CEO)',
            Asal_Pakan: 'London',
            Pakan_batch_id: 47,
            Jenis_butiran: 61,
            Tanggal_beli: 61,
        ...
        },
        {
            ...
            Tanggal_dan_jam_input: 'Developer',
            Asal_Pakan: 'Edinburgh',
            Pakan_batch_id: 42,
            Jenis_butiran: 61,
            Tanggal_beli: 61,
