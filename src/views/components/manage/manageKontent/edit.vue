                ...
                <li>
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page"><span>Input Manage Kontent Edukasi</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                            ...
                            <div class="box-wrap">
                                    ...
                                    <div class="custom-file-container">
                                        <div class="invoice-logo">
                                            <div class="upload pe-md-5">
                                                <input ref="fl_profile" type="file" name="gambar" class="d-none" accept="image/*" @change="change_file" />
                                                <img
                                                    v-if="selected_file"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file-container">
                                        <div class="invoice-logo">
                                            <div class="upload pe-md-5">
                                                <input ref="fl_profile" type="file" name="video" class="d-none" accept="image/*" @change="change_file" />
                                                <img
                                                    v-if="selected_file"
                                                    :src="selected_file ? selected_file : require('@/assets/images/user-profile.jpeg')"
                                                    alt="profile"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file-container">
                                        <div class="invoice-logo">
                                            <div class="upload pe-md-5">
                                                <input ref="fl_profile" type="file" name="pdf" class="d-none" accept="image/*" @change="change_file" />
                                                <img
                                                    v-if="selected_file"
                                                    :src="selected_file ? selected_file : require('@/assets/images/user-profile.jpeg')"
                                                    alt="profile"
                            ...
                            <div class="box-wrap">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group mb-0">
                                        <flat-pickr v-model="date1" name="tanggal_input" class="form-control flatpickr active"></flat-pickr>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Jam Input</label>
                                    <input type="text" name="jam" class="form-control" placeholder="Masukkan jam input" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="deskripsi" class="form-control" placeholder="Beri deskripsi" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">No. of like</label>
                                    <input type="number" name="tinggi_kolam" class="form-control" placeholder="Masukkan No. of like" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">No. of view</label>
                                    <input type="number" name="luas_kolam" class="form-control" placeholder="Masukkan No. of view" />
                                </div>
