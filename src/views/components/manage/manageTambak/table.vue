                ...
                <div class="panel br-6 p-0">
                    <div class="custom-table">
                        ...
                        <div class=" d-flex flex-row-reverse position-relative">
                            <router-link to="/manage-tambak/create" @click="toggleMobileMenu" class="btn btn-primary mb-2 mx-3 tambah-data">Tambah Data</router-link>
                        </div>
...
<script setup>
    ...
    const columns = ref(['nama_tambak', 'alamat', 'nama_area', 'provinsi', 'photo', 'map_location', 'status', 'actions']);
    const items = ref([]);
    ...
    const bind_data = () => {
        items.value = [
            ...
            },
            {
                ...
                alamat: 'Junior Technical Author',
                nama_area: 'San Francisco',
                provinsi: 66,
                photo: '2009/01/12',
                map_location: 'null',
                status: '86,000',
            },
            {
                ...
                alamat: 'Senior Javascript Developer',
                nama_area: 'Edinburgh',
                provinsi: 22,
                photo: '2012/03/29',
                map_location: 'null',
            ...
            },
            {
                ...
                alamat: 'Senior Marketing Designer',
                nama_area: 'London',
                provinsi: 43,
                photo: '2012/12/18',
                map_location: 'null',
            ...
            },
            {
                ...
                alamat: 'Chief Financial nama_arear (CFO)',
                nama_area: 'New York',
                provinsi: 64,
                photo: '2010/06/09',
                map_location: 'null',
            ...
            },
            {
                ...
                alamat: 'Chief Marketing nama_arear (CMO)',
                nama_area: 'New York',
                provinsi: 40,
                photo: '2009/06/25',
                map_location: 'null',
            ...
            },
            {
                ...
                alamat: 'Chief Executive nama_arear (CEO)',
                nama_area: 'London',
                provinsi: 47,
                photo: '2009/10/09',
                map_location: 'null',
