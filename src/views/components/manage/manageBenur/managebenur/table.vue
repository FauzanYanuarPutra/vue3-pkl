                ...
                <div class="panel br-6 p-0">
                    <div class="custom-table">
                        ...
                        <div class="d-flex flex-row-reverse position-relative">
                            <router-link to="/manage-Benur/create" @click="toggleMobileMenu"
...
const columns = ref(['nama_tambak', 'tanggal_input', 'Id_benur', 'Asal_benur', 'benur_batch_id', 'usia_benur', 'actions']);
const items = ref([]);
...
const view_row = (item) => {
    new window.Swal({
        ...
        html:
            ...
            '<p><b>Panjang Benur</b> : ' + item.Panjang_benur + '</p>' +
            '<p><b>Size Varian</b> : ' + item.Size_varian + '</p>' +
            '<p><b>Hepatopankreas</b> : ' + item.Hepatopankreas + '</p>' +
            '<p><b>Necrosis</b> : ' + item.Necrosis + '</p>' +
            '<p><b>MGR</b> : ' + item.MGR + '</p>' +
            '<p><b>Ektoparasite</b> : ' + item.Ektoparasite + '</p>' +
            '<p><b>Stress Test</b> : ' + item.Stress_test + '</p>' +
            '<p><b>Vibrio Luminnescen</b> : ' + item.Vibrio_luminnescen + '</p>' +
            '<p><b>TVC</b> : ' + item.TVC + '</p>' +
            '<p><b>pH</b> : ' + item.pH + '</p>' +
