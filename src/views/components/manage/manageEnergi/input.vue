                        ...
                        <form class="form-vertical" action="#">
                            <div class="box-wrap">
                                ...
                                <div class="form-group">
                                    ...
                                    <multiselect v-model="inputs['input2']" :options="bulan" :searchable="true"
                                        placeholder="Choose..." selected-label="" select-label="" deselect-label="">
                                    </multiselect>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <multiselect v-model="inputs['input3']" :options="sumberEnergi" :searchable="true"
                                        placeholder="Choose..." selected-label="" select-label="" deselect-label="">
                                    </multiselect>
                                </div>
                            ...
                            <div class="box-wrap" v-if="inputs['input3'] === 'Listrik'">
                                ...
                                <div class="form-group">
                                    ...
                                    <multiselect v-model="inputs['input4']" :options="konsumsiListrik"
