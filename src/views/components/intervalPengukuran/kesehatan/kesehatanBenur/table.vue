                        ...
                        <v-client-table :data="items" :columns="columns" :options="table_option">
                            <template #actions="props">
                                <div class="table-controls d-flex no-wrap justify-content-center">
                                    ...
                                    <div class="px-2">
                                        <router-link to="/kesehatan-benur/edit" data-bs-toggle="tooltip" title="Edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"
...
const table_option = ref({
    ...
    columnsClasses: { kesehatan_benur: 'text-end', actions: 'actions text-center' },
...
const view_row = (item) => {
    new window.Swal({
        title: '<i>Kesehatan benur</i>',
        text: 'HALLO',
        html:
            '<p><b>Kesehatan Benur</b> : ' + item.kesehatan_benur + '</p>'
