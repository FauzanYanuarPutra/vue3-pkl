                ...
                <li>
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page"><span>Table Siklus budidaya (Udang)</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
...
<<<<<<< HEAD
                        <div class="d-flex flex-row-reverse position-relative">
                            <router-link to="/budidaya-udang/create" @click="toggleMobileMenu" class="btn mb-2 mx-3 tambah-data">Tambah Data</router-link>
=======
                        <div class=" d-flex flex-row-reverse position-relative">
                            <router-link to="/budidaya-udang/create" @click="toggleMobileMenu"
...
<script setup>
    ...
    const columns = ref(['siklus_udang', 'actions']);
    const items = ref([]);
    ...
    const view_row = (item) => {
        new window.Swal({
            ...
            text: 'HALLO',
            html: '<p><b>Siklus Budidaya Udang</b> : ' + item.siklus_udang + '</p>',
