                        ...
                        <v-client-table :data="items" :columns="columns" :options="table_option">
                            <template #actions="props">
                                <div class="table-controls d-flex no-wrap justify-content-center">
                                    ...
                                    <div class="px-2">
                                        <router-link to="/budidaya-kimia/create" data-bs-toggle="tooltip" title="Edit">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="24"
                                                height="24"
...
<script setup>
    ...
    const columns = ref(['pH', 'Salinitas', 'DO', 'CO3', 'actions']);
    const items = ref([]);
    const table_option = ref({
        perPage: 50,
        perPageValues: [5, 10, 20, 50],
        skin: 'table table-hover',
        columnsClasses: { actions: 'actions text-center', nama: ' text-dark fw-bold', pH: 'text-end', Salinitas: 'text-end', DO: 'text-end', CO3: 'text-end' },
        ...
        sortable: ['pH', 'Salinitas', 'DO', 'CO3', 'HC03', 'Total', 'Ammonium_NH4', 'Nitrit_NO2', 'Nitrit_NO3', 'hosphate_PO4', 'Iron_Fe', 'Magnesium_Mg', 'Calium_Ca', 'Total', 'Residual ', 'Redox'],
        sortIcon: {
            base: 'sort-icon-none',
            up: 'sort-icon-asc',
            down: 'sort-icon-desc',
