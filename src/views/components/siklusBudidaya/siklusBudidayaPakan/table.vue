                ...
                <div class="panel br-6 p-0">
                    <div class="custom-table">
                        ...
                        <div class=" d-flex flex-row-reverse position-relative">
                            <router-link to="/siklus-budidaya-pakan/create" @click="toggleMobileMenu" class="btn btn-primary mb-2 mx-3 tambah-data">Tambah Data</router-link>
                        </div>
...
<script setup>
    ...
    const table_option = ref({
        ...
        sortable: ['nama_kolam', 'tanggal_input', 'merek_pakan', 'pakan', 'pemberian_pakan', 'kumulative', 'fcr'],
        sortIcon: {
            base: 'sort-icon-none',
            up: 'sort-icon-asc',
            down: 'sort-icon-desc',
