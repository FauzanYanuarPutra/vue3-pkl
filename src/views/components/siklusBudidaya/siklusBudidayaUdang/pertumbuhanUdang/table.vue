                ...
                <div class="panel br-6 p-0">
                    <div class="custom-table">
                        ...
                        <div class="d-flex flex-row-reverse position-relative">
                            <router-link to="/pertumbuhan-udangs/create" @click="toggleMobileMenu" class="btn y mb-2 mx-3 tambah-data">Tambah Data</router-link>
                        </div>
                        ...
                        <template #no="props" v-for="index in items" >
                            ...
                            <template #actions="props">
                                <div class="table-controls d-flex no-wrap justify-content-center">
                                    ...
                                    <div class="mx-2">
                                        <router-link to="/pertumbuhan-udangs/edit" data-bs-toggle="tooltip" title="Edit">
                                            <svg
...
<script setup>
    ...
    const columns = ref(['no', 'nama_tambak', 'nama_kolam', 'tanggal', 'ABW', 'ADG', 'SR', 'DOC',  'actions']);
    const items = ref([]);
    const table_option = ref({
        ...
        sortable: ['nama_tambak', 'nama_kolam', 'tanggal', 'ABW', 'ADG', 'SR', 'DOC', ],
        sortIcon: {
            base: 'sort-icon-none',
            up: 'sort-icon-asc',
            down: 'sort-icon-desc',
