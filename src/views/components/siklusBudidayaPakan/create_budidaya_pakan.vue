                    ...
                    <div class="panel-body">
                        <form class="form-vertical" action="#">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select id="select" class="form-select" name="merek_pakan">
                                        <option value="1">Nama Pabrik</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select id="select" class="form-select" name="auto_feeder">
                                        <option value="1">Nama Auto Feeder</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
