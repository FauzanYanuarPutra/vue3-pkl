                ...
                <div class="panel br-6 p-0">
                    <div class="custom-table">
                        ...
                        <div class=" d-flex flex-row-reverse position-relative">
                            <router-link to="/perkiraan/create" @click="toggleMobileMenu" class="btn btn-primary mb-2 mx-3 tambah-data">Tambah Data</router-link>
                        </div>
                        ...
                        <v-client-table :data="items1" :columns="columns1" :options="table_option1">
                            <template #actions="props">
                                <div class="table-controls d-flex no-wrap justify-content-center">
                                    <div class="px-2">
                                        <router-link to="/perkiraan/edit" data-bs-toggle="tooltip" title="Edit">
                                            <svg
...
<script setup>
    ...
    const bind_data = () => {
        items.value = [
            ...
            {
                id: 2,
                Id_kolam: 'Garrett Winters',
                Tanggal_panen: 'Accountant',
                Tipe_panen: 63,
                Doc: '2011/07/25',
            },
            {
                id: 3,
                Id_kolam: 'Ashton Cox',
                Tanggal_panen: 'Junior Technical Author',
                Tipe_panen: 66,
                Doc: '2009/01/12',
            },
            {
                id: 4,
                Id_kolam: 'Cedric Kelly',
                Tanggal_panen: 'Senior Javascript Developer',
                Tipe_panen: 22,
                Doc: '2012/03/29',
            },
            {
            ...
            {
                id: 6,
                Id_kolam: 'Brielle Williamson',
                Tanggal_panen: 'Integration Specialist',
                Tipe_panen: 61,
                Doc: '2012/12/02',
            },
            {
                id: 7,
                Id_kolam: 'Herrod Chandler',
                Tanggal_panen: 'Sales Assistant',
                Tipe_panen: 59,
                Doc: '2012/08/06',
            },
            {
                id: 8,
                Id_kolam: 'Rhona Davidson',
                Tanggal_panen: 'Integration Specialist',
                Tipe_panen: 55,
                Doc: '2010/10/14',
            },
            {
                id: 9,
                Id_kolam: 'Colleen Hurst',
                Tanggal_panen: 'Javascript Developer',
                Tipe_panen: 39,
                Doc: '2009/09/15',
            },
        ];
    ...
    const table_option2 = ref({
        ...
        sortable: ['ABW', 'Size', 'Total_biomassa', 'Total_populasi', 'Total_kebutuhan_pakan', 'FCR', 'SR', 'Produktivity', 'Jumlah_udang_fresh', 'Jumlah_udang_molting', 'Jumlah_udang_broken'],
        sortIcon: {
            base: 'sort-icon-none',
            up: 'sort-icon-asc',
            down: 'sort-icon-desc',
